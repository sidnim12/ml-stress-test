...
from ml_stress_test.tests.noise import run_noise_stress_test, NoiseStressConfig
from ml_stress_test.tests.feature_drop import run_feature_drop_test
from ml_stress_test.tests.missingness import run_missingness_shock_test, MissingnessShockConfig

# âœ… Phase 5
from ml_stress_test.tests.covariate_shift import run_covariate_shift_test, CovariateShiftConfig
...
def run_all_stress_tests(
    *,
    ...
    # -------------------------
    # Phase 3 â€” Feature Drop (leakage-safe if split exists)
    # -------------------------
    def _feature_drop():
